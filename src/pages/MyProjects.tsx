          ...
          <div className="flex flex-wrap gap-3.5">
            {projects.map((project) => (
              ...
              >
                ...
                <div onClick={(e)=>e.stopPropagation()}><TrashIcon onClick={()=>deleteProject(project.id)} className="absolute top-3 right-3 sclae-0 group-hover:scale-200 bg-white p-1.5 size-6 rounded text-red-500 text-xl cursor-pointer transition-all" /></div>
              </div>
            ))}
          </div>
        </div>
